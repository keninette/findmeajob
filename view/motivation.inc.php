<form id="form-motivation" action="" method="POST">
    ...
    <fieldset class="row">
        ...
        <input type="text" id="form-motivation['subject']" name="form-motivation['subject']" class="col-xs-12" />
    </fieldset>
    ...
    <fieldset class="row">
        ...
        <textarea name="form-motivation['content']" id="form-motivation['content']" class="col-xs-12" rows="35"></textarea>
    </fieldset>
