...
<form action="index.php?page=application" method="POST">
    ...
    <fieldset class="row" id="block-recruiter">
        ...
        <input type="email" id="form-application[email]" name="form-application[email]" placeholder="demontigny.jeangilles@protonmail.com" class="col-xs-12" required />
        <label class="small-margin-top" for="form-application[salutation]">Civilité</label><br />
        <input type="text" id="form-application[salutation]" name="form-application[salutation]" placeholder="Mr De Montigny Jean-Gilles"  class="col-xs-12" required />
        <label class="small-margin-top" for="form-application[company]">Entreprise</label><br />
        <input type="text" class="col-xs-12" id="form-application[company]" name="form-application[company]" placeholder="Jean-Gilles inc." required /><br />
    ...
    <fieldset class="row" id="block-motivation-custom">
        ...
        <textarea name="form-application[motivation]" id="form-application[motivation]" rows="10" class="col-xs-12" placeholder="En vrai, j'ai cher envie de taffer chez vous !" required></textarea>
    </fieldset>
    <fieldset class="row">
